...
element_module(hbox) -> nit_el_hbox;
element_module(button) -> nit_el_button;
element_module(input) -> nit_el_input;
element_module(table) -> nit_el_table;
element_module(tabs) -> nit_el_tabs;
element_module(modal) -> nit_el_modal;
element_module(tab) -> nit_el_tab;
element_module(table_col) -> nit_el_table_col;
%% Observer-style elements
element_module(progress_bar) -> nit_el_progress_bar;
element_module(sparkline) -> nit_el_sparkline;
element_module(stat_row) -> nit_el_stat_row;
element_module(status_bar) -> nit_el_status_bar;
element_module(header) -> nit_el_header;
element_module(tree) -> nit_el_tree;
element_module(tree_node) -> nit_el_tree;  %% tree_node is handled by tree
element_module(spacer) -> nit_el_spacer;
element_module(scroll) -> nit_el_scroll;
