%%%-------------------------------------------------------------------
%%% @doc Unit tests for nit_bounds.
%%% @end
%%%-------------------------------------------------------------------
-module(nit_bounds_tests).
...
find_table_bounds_inside_tabs_test() ->
    ...
    {ok, TableBounds} = nit_bounds:find_element_bounds(Tree, proc_table, RootBounds),
...
find_button_bounds_inside_nested_vbox_with_spacer_test() ->
    ...
    {ok, ButtonBounds} = nit_bounds:find_element_bounds(Tree, bottom_btn, RootBounds),
...
find_auto_hbox_child_bounds_share_width_test() ->
    ...
    {ok, RightBounds} = nit_bounds:find_element_bounds(Tree, right_box, RootBounds),
